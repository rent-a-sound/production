...
const Hero = () => {
  ...
  return (
    <div name="container" className='w-full h-full bg-neutral-950 flex flex-col md:flex-row items-center md:items-start md:justify-between font-montserrat'>
        <div name="left-half" className={`text-white m-8 -mb-10 md:m-16 flex flex-col items-center ${isTranslated ? 'opacity-0' : 'opacity-100'} duration-300`}>
        <div>
            ...
            <div name="banner-container" onClick={handleClick} className="grid grid-cols-1 grid-rows-1 mb-12 lg:mb-0 mr-3 lg:mr-32 lg:mt-12 relative -mt-8">
                <img src={partybox110} className={`absolute top-20 left-48 lg:top-24 lg:left-72 max-h-48 lg:max-h-72 ${isAnimating ? 'animate-nilemation1' : ''}`}/>
                <img src={partybox310f} className={`absolute max-h-72 lg:max-h-96 left-16 lg:left-32 top-2 lg:top-5 ${isAnimating ? 'animate-nilemation2' : ''}`}/>
                <img src={partybox310s} className={`absolute max-h-72 lg:max-h-96 right-28 lg:right-28 ${isAnimating ? 'animate-nilemation3' : ''}`}/>
                <img src={partybox710} className={`max-h-72 lg:max-h-96 mr-12 -ml-6 lg:ml-0 lg:mr-6 mt-12 z-0 lg:mt-16 ${isAnimating ? 'animate-nilemation4' : ''}`}/>
            </div>
        </div>
        <div name='right-half' className="text-white flex flex-col items-center justify-center md:m-8">
            <div className="flex items-center justify-center flex-col bg-neutral-900 p-4 rounded-2xl mb-10 px-6" >
                ...
                <div onClick={translate} name='novi-sad' className="bg-neutral-800 w-72 h-24 my-6 rounded-3xl flex flex-col items-center justify-center tracking-wide">
            ...
            <div className={`flex items-center justify-center flex-col bg-neutral-900 p-4 rounded-2xl px-6 mb-12 md:mb-8 ${isTranslated ? 'opacity-0' : 'opacity-100'} duration-300`}>
                <div name="contact-title" className="text-4xl font-bold mb-6 mt-3 tracking-wide">KONTAKT</div>
                ...
                <div name="phone" className="bg-neutral-800 h-24 w-72 rounded-3xl flex-col items-center justify-center font-bold text-2xl tracking-wide mb-6">
                    <div className="flex flex-row items-center mt-4 ml-4"><BsFillTelephoneFill className="text-xl mr-2 text-green-500"/>TELEFON</div>
