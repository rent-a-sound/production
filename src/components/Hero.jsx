...
const Hero = () => {
  return (
    <div name="container" className='w-full h-screen md:-mt-16 bg-neutral-800 flex flex-col md:flex-row items-center justify-between md:justify-between font-montserrat'>
        <div name="left-half" className='text-white m-8 md:m-16 flex flex-col items-start justify-around'>
            ...
            <img className="h-1/2" src={partyBox310}></img>
    </div>
  )
}
